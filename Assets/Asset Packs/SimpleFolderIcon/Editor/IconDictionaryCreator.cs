...
namespace SimpleFolderIcon.Editor
{
    ...
    {
        private const string AssetsPath = "Asset Packs/SimpleFolderIcon/Icons";
        ...
        internal static void BuildDictionary()
        {
            ...
            {
                var texture = (Texture)AssetDatabase.LoadAssetAtPath($"Assets/Asset Packs/SimpleFolderIcon/Icons/{f.Name}", typeof(Texture2D));
            ...
            {
                var folderIconSO = (FolderIconSO)AssetDatabase.LoadAssetAtPath($"Assets/Asset Packs/SimpleFolderIcon/Icons/{f.Name}", typeof(FolderIconSO));
